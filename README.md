...
```bash
wget https://raw.githubusercontent.com/Seameee/vps-audit/main/vps-audit.sh -O vps-audit.sh
# or
curl -O https://raw.githubusercontent.com/Seameee/vps-audit/main/vps-audit.sh
```
